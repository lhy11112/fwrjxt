      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="设备唯一标识" prop="deviceId">
            <el-input v-model="form.deviceId" :placeholder="'请输入'" clearable>
            </el-input>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="设备IP地址" prop="deviceIp">
            <el-input v-model="form.deviceIp" :placeholder="'请输入'" clearable>
            </el-input>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="设备端口" prop="devicePort">
            <el-input v-model="form.devicePort" :placeholder="'请输入'" clearable>
            </el-input>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="有效性" prop="isValid">
            <el-select v-model="form.isValid" :placeholder="'请输入'" clearable>
              <el-option v-for="(item,index) in isValidOption" :key="index" :label="item.label" :value="item.value"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="侦测半径(km)" prop="zcbj">
            <el-input v-model="form.zcbj" :placeholder="'请输入'" clearable>
            </el-input>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="协议类型" prop="type">
            <el-select v-model="form.type" :placeholder="'请输入'" clearable>
        ...
        <el-col :span="24">
          <el-form-item label="弹药情况" prop="dyqk">
            <el-input type="textarea" v-model="form.dyqk" autosize :placeholder="'请输入'" clearable>
            </el-input>
          </el-form-item>
        </el-col>
      </el-row>
...
import { checkSpaceTss,validateIp,validatePort} from "@/utils/index.js"
export default {
  props:{
    toDp:{
      type:Boolean,
  ...
  data() {
    return {
      ...
      rules: {
        ...
        deviceId: [{ required: true,trigger: 'blur', message: "请输入设备唯一标识" }],
        stationId: [{ required: true, validator: checkSpaceTss,trigger: 'blur', message: "请输入站ID"  }],
        deviceType: [{ required: true, trigger: 'blur', message: "请选择设备类型"  }],
        deviceIp: [{ required: true,validator: validateIp,trigger: 'blur'  }],
        devicePort: [{ required: true,validator: validatePort,trigger: 'blur'}],
      },
      deviceTypeOption:[
        {
          label:'侦测',
