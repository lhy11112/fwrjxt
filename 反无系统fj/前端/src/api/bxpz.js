...
export default {
  baseURL: `${config.API_URL}/wrj/wjbdWrjBxpz`,
  // 
  list: async function (params) {
    return await http.get(`${this.baseURL}/list`, params);
  },
  listTree: async function (params) {
    return await http.get(`${this.baseURL}/listTree`, params);
  },
  ...
  getDxdmByJwdAndJl: async function (params) {
    return await http.get(`${this.baseURL}/getDxdmByJwdAndJl`, params);
  },
}