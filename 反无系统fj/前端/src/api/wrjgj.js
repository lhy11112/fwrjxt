...
export default {
  ...
  qstjEj: async function (params) {
    return await http.get(`${this.baseURL}/qstjEj`, params);
  },
  qetGjys: async function (params) {
    return await http.get(`${this.baseURL}/qetGjys`, params);
  },
}
