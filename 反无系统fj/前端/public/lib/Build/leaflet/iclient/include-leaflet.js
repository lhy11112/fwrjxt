...
(function () {
    ...
    function load(config) {
		...
		inputScript(libsurl + '/plotting/leaflet/11.2.0/iclient-plot-algorithms-jb-es6.min.js');
                inputScript(libsurl + '/plotting/leaflet/11.2.0/iclient-plot-algorithms-wj-es6.min.js');
                inputScript(libsurl + '/plotting/leaflet/11.2.0/iclient-plot-algorithms-yj-es6.min.js');
            } else {
                inputScript(libsurl + '/plotting/leaflet/11.2.0/iclient-plot-leaflet.min.js');
		inputScript(libsurl + '/plotting/leaflet/11.2.0/iclient-plot-algorithms-jb.min.js');
                inputScript(libsurl + '/plotting/leaflet/11.2.0/iclient-plot-algorithms-wj.min.js');
                inputScript(libsurl + '/plotting/leaflet/11.2.0/iclient-plot-algorithms-yj.min.js');
            }
        }
