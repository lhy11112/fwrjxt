...
(function () {
    ...
    function load(config) {
        ...
        if (inArray(includes, 'iclient-plot-leaflet')) {
            inputCSS(libsurl + '/plotting/leaflet/11.1.1/iclient-plot-leaflet.css');
            if (supportES6()) {
                inputScript(libsurl + '/plotting/leaflet/11.1.1/iclient-plot-leaflet-es6.min.js');
				
				inputScript(libsurl + '/plotting/leaflet/11.1.1/iclient-plot-algorithms-jb-es6.min.js');
				inputScript(libsurl + '/plotting/leaflet/11.1.1/iclient-plot-algorithms-wj-es6.min.js');
				inputScript(libsurl + '/plotting/leaflet/11.1.1/iclient-plot-algorithms-yj-es6.min.js');
            } else {
                inputScript(libsurl + '/plotting/leaflet/11.1.1/iclient-plot-leaflet.min.js');
				
				inputScript(libsurl + '/plotting/leaflet/11.1.1/iclient-plot-algorithms-jb.min.js');
				inputScript(libsurl + '/plotting/leaflet/11.1.1/iclient-plot-algorithms-wj.min.js');
				inputScript(libsurl + '/plotting/leaflet/11.1.1/iclient-plot-algorithms-yj.min.js');
            }
        }
