...
pub fn build_routes(state: AppState) -> Router {
    ...
    let api_routes = Router::new()
        ...
        // ---- wrj 武警业务 ----
        .route("/api/v1/wrj/fwzf", get(wrj::list_fwzf)).route("/api/v1/wrj/fwzf", post(wrj::add_fwzf))
        .route("/api/v1/wrj/fwzf/batch-delete", post(wrj::batch_delete_fwzf))
        .route("/api/v1/wrj/fwzf/{id}", get(wrj::get_fwzf)).route("/api/v1/wrj/fwzf/{id}", put(wrj::edit_fwzf)).route("/api/v1/wrj/fwzf/{id}", axum::routing::delete(wrj::delete_fwzf))
        .route("/api/v1/wrj/fzzb", get(wrj::list_fzzb)).route("/api/v1/wrj/fzzb", post(wrj::add_fzzb))
        .route("/api/v1/wrj/fzzb/batch-delete", post(wrj::batch_delete_fzzb))
        .route("/api/v1/wrj/fzzb/{id}", get(wrj::get_fzzb)).route("/api/v1/wrj/fzzb/{id}", put(wrj::edit_fzzb)).route("/api/v1/wrj/fzzb/{id}", axum::routing::delete(wrj::delete_fzzb))
        .route("/api/v1/wrj/bxpz", get(wrj::list_bxpz)).route("/api/v1/wrj/bxpz", post(wrj::add_bxpz))
        .route("/api/v1/wrj/bxpz/batch-delete", post(wrj::batch_delete_bxpz))
        .route("/api/v1/wrj/bxpz/tree", get(wrj::list_bxpz_tree))
        .route("/api/v1/wrj/bxpz/{id}", get(wrj::get_bxpz)).route("/api/v1/wrj/bxpz/{id}", put(wrj::edit_bxpz)).route("/api/v1/wrj/bxpz/{id}", axum::routing::delete(wrj::delete_bxpz))
        .route("/api/v1/wrj/zymb", get(wrj::list_zymb)).route("/api/v1/wrj/zymb", post(wrj::add_zymb))
        .route("/api/v1/wrj/zymb/batch-delete", post(wrj::batch_delete_zymb))
        .route("/api/v1/wrj/zymb/{id}", get(wrj::get_zymb)).route("/api/v1/wrj/zymb/{id}", put(wrj::edit_zymb)).route("/api/v1/wrj/zymb/{id}", axum::routing::delete(wrj::delete_zymb))
        .route("/api/v1/wrj/kysq", get(wrj::list_kysq)).route("/api/v1/wrj/kysq", post(wrj::add_kysq))
        .route("/api/v1/wrj/kysq/{id}", axum::routing::delete(wrj::delete_kysq))
        .route("/api/v1/wrj/czsp", get(wrj::list_czsp)).route("/api/v1/wrj/czsp", post(wrj::add_czsp))
        .route("/api/v1/wrj/czsp/batch-delete", post(wrj::batch_delete_czsp))
        .route("/api/v1/wrj/czsp/{id}", get(wrj::get_czsp)).route("/api/v1/wrj/czsp/{id}", put(wrj::edit_czsp)).route("/api/v1/wrj/czsp/{id}", axum::routing::delete(wrj::delete_czsp))
        .route("/api/v1/wrj/scj", get(wrj::list_scj)).route("/api/v1/wrj/scj", post(wrj::add_scj))
        .route("/api/v1/wrj/scj/batch-delete", post(wrj::batch_delete_scj))
        .route("/api/v1/wrj/scj/tree", get(wrj::list_scj_tree))
        .route("/api/v1/wrj/scj/{id}", get(wrj::get_scj)).route("/api/v1/wrj/scj/{id}", put(wrj::edit_scj)).route("/api/v1/wrj/scj/{id}", axum::routing::delete(wrj::delete_scj))
        .route("/api/v1/wrj/jkgl", get(wrj::list_jkgl)).route("/api/v1/wrj/jkgl", post(wrj::add_jkgl))
        .route("/api/v1/wrj/jkgl/batch-delete", post(wrj::batch_delete_jkgl))
        .route("/api/v1/wrj/jkgl/{id}", get(wrj::get_jkgl)).route("/api/v1/wrj/jkgl/{id}", put(wrj::edit_jkgl)).route("/api/v1/wrj/jkgl/{id}", axum::routing::delete(wrj::delete_jkgl))
        .route("/api/v1/wrj/tyjh", get(wrj::list_tyjh)).route("/api/v1/wrj/tyjh", post(wrj::add_tyjh))
        .route("/api/v1/wrj/tyjh/batch-delete", post(wrj::batch_delete_tyjh))
        .route("/api/v1/wrj/tyjh/{id}", get(wrj::get_tyjh)).route("/api/v1/wrj/tyjh/{id}", put(wrj::edit_tyjh)).route("/api/v1/wrj/tyjh/{id}", axum::routing::delete(wrj::delete_tyjh))
        .route("/api/v1/wrj/tyjh-data", get(wrj::list_tyjh_data)).route("/api/v1/wrj/tyjh-data", post(wrj::add_tyjh_data))
        .route("/api/v1/wrj/tyjh-data/batch-delete", post(wrj::batch_delete_tyjh_data))
        .route("/api/v1/wrj/tyjh-data/{id}", get(wrj::get_tyjh_data)).route("/api/v1/wrj/tyjh-data/{id}", put(wrj::edit_tyjh_data)).route("/api/v1/wrj/tyjh-data/{id}", axum::routing::delete(wrj::delete_tyjh_data))
        .route("/api/v1/wrj/jbxx-new", get(wrj::list_jbxx_new)).route("/api/v1/wrj/jbxx-new", post(wrj::add_jbxx_new))
        .route("/api/v1/wrj/jbxx-new/batch-delete", post(wrj::batch_delete_jbxx_new))
        .route("/api/v1/wrj/jbxx-new/{id}", get(wrj::get_jbxx_new)).route("/api/v1/wrj/jbxx-new/{id}", put(wrj::edit_jbxx_new)).route("/api/v1/wrj/jbxx-new/{id}", axum::routing::delete(wrj::delete_jbxx_new))
        .route("/api/v1/wrj/zsk", get(wrj::list_zsk)).route("/api/v1/wrj/zsk", post(wrj::add_zsk))
        .route("/api/v1/wrj/zsk/{id}", get(wrj::get_zsk)).route("/api/v1/wrj/zsk/{id}", put(wrj::edit_zsk)).route("/api/v1/wrj/zsk/{id}", axum::routing::delete(wrj::delete_zsk))
        .route("/api/v1/wrj/zsk-wj", get(wrj::list_zsk_wj)).route("/api/v1/wrj/zsk-wj", post(wrj::add_zsk_wj))
        .route("/api/v1/wrj/zsk-wj/{id}", get(wrj::get_zsk_wj)).route("/api/v1/wrj/zsk-wj/{id}", put(wrj::edit_zsk_wj)).route("/api/v1/wrj/zsk-wj/{id}", axum::routing::delete(wrj::delete_zsk_wj))
        .route("/api/v1/wrj/zsk-wj-nr", get(wrj::list_zsk_wj_nr)).route("/api/v1/wrj/zsk-wj-nr", post(wrj::add_zsk_wj_nr))
        .route("/api/v1/wrj/spectrum-result", get(wrj::list_spectrum_result)).route("/api/v1/wrj/spectrum-result", post(wrj::add_spectrum_result))
        .route("/api/v1/wrj/spectrum-result/{id}", get(wrj::get_spectrum_result)).route("/api/v1/wrj/spectrum-result/{id}", put(wrj::edit_spectrum_result))
        .route("/api/v1/wrj/dxyy-bh", get(wrj::list_dxyy_bh)).route("/api/v1/wrj/dxyy-bh", post(wrj::add_dxyy_bh))
        .route("/api/v1/wrj/dxyy-bh/{id}", get(wrj::get_dxyy_bh)).route("/api/v1/wrj/dxyy-bh/{id}", put(wrj::edit_dxyy_bh))
        .route("/api/v1/wrj/lpwj", get(wrj::list_lpwj)).route("/api/v1/wrj/lpwj", post(wrj::add_lpwj))
        .route("/api/v1/wrj/lpwj/{id}", put(wrj::edit_lpwj))
        .route("/api/v1/wrj/dxdm", get(wrj::list_dxdm)).route("/api/v1/wrj/dxdm", post(wrj::add_dxdm))
        .route("/api/v1/wrj/dxdm/batch-delete", post(wrj::batch_delete_dxdm))
        .route("/api/v1/wrj/dxdm/{id}", get(wrj::get_dxdm)).route("/api/v1/wrj/dxdm/{id}", put(wrj::edit_dxdm)).route("/api/v1/wrj/dxdm/{id}", axum::routing::delete(wrj::delete_dxdm))
        .route("/api/v1/wrj/yhgl-cs", get(wrj::list_yhgl_cs)).route("/api/v1/wrj/yhgl-cs", post(wrj::add_yhgl_cs))
        .route("/api/v1/wrj/yhgl-cs/{id}", put(wrj::edit_yhgl_cs))
        .route("/api/v1/wrj/zzll-bd", get(wrj::list_zzll_bd)).route("/api/v1/wrj/zzll-bd", post(wrj::add_zzll_bd))
        .route("/api/v1/wrj/zzll-bd/{bdnm}", put(wrj::edit_zzll_bd))
        .route("/api/v1/wrj/zzll-bd-bs", get(wrj::list_zzll_bd_bs)).route("/api/v1/wrj/zzll-bd-bs", post(wrj::add_zzll_bd_bs))
        .route("/api/v1/wrj/operation-log", get(wrj::list_operation_log)).route("/api/v1/wrj/operation-log", post(wrj::add_operation_log))
        .route("/api/v1/wrj/operation-log/{id}", put(wrj::edit_operation_log))
        // ---- 地图服务 ----
